    ...
    namespace detail {
        namespace json {
            ...
            const Array& Node::AsArray() const {
                if (!IsArray()) {
                    throw std::logic_error("IsArray contains a value of a different type"s);
                }
                else {
            ...
            const Dict& Node::AsDict() const {
                if (!IsDict()) {
                    throw std::logic_error("IsDict contains a value of a different type"s);
                }
                else {
            ...
            bool Node::AsBool() const {
                if (!IsBool()) {
                    throw std::logic_error("IsBool contains a value of a different type"s);
                }
                else {
            ...
            int Node::AsInt() const {
                if (!IsInt()) {
                    throw std::logic_error("IsInt contains a value of a different type"s);
                }
                else {
            ...
            double Node::AsDouble() const {
                if (!IsDouble()) {
                    throw std::logic_error("IsDouble contains a value of a different type"s);
                }
            ...
            const std::string& Node::AsString() const {
                if (!IsString()) {
                    throw std::logic_error("IsString contains a value of a different type"s);
                }
                else {
